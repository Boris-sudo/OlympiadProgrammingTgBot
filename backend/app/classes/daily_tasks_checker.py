                ...
                while done:
                    ...
                    for solved_task in solved_tasks:
                        ...
                        if time_datetime == yesterday:
                            if solved_task['verdict'] == 'OK' and solved_task['problem']['index'] == task_index and solved_task['problem']['contestId'] == task_contestId:
                                found = True
                                tries_count += 1
                            elif solved_task['problem']['index'] == task_index and solved_task['contestId'] == task_contestId:
                                tries_count += 1
                        else:
                            done = False
                            break
...
def check_daily_task_checking_done():
    yesterday = datetime.date.today() - datetime.timedelta(days=DAYS_AFTER_CHECK)
